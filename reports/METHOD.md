# Liga Five Guys — how the numbers are made — 2026-09-17 06:09 UTC
...
|---|---|---|---|--:|---|---|
| 🟢 | api_activity | every transfer, which is what the ledger replays — one row per deal, so the newest is the last deal and not the last sweep | LaLiga Fantasy API | 208 | 16 Sep 21:15 | fetched 3 minutes ago |
| 🟢 | api_leagues | your cash and the league's id | LaLiga Fantasy API | 197 | 17 Sep 06:07 | fetched 3 minutes ago |
| 🟢 | api_lineup | the eleven you have actually fielded, and the formation the app says you are playing | LaLiga Fantasy API | 1,914 | 17 Sep 06:07 | fetched 3 minutes ago |
| 🟢 | api_market | what is on offer, and the bids on it | LaLiga Fantasy API | 6,038 | 17 Sep 06:07 | fetched 3 minutes ago |
| 🟢 | api_players | names for players nobody owns any more — one row per player, first sighting kept | LaLiga Fantasy API | 134 | 16 Sep 21:15 | fetched 9 hours ago |
| 🟢 | api_standings | the league table — position, points, squad value, and your balance | LaLiga Fantasy API | 985 | 17 Sep 06:07 | fetched 3 minutes ago |
| 🟢 | api_stats | what the app scored each player, broken into what he did — one row per player per week per stat, a correction being a later row rather than an overwrite | LaLiga Fantasy API | 12,000 | 17 Sep 06:07 | fetched 3 minutes ago |
| 🟢 | api_teams | all five squads | LaLiga Fantasy API | 14,086 | 17 Sep 06:07 | fetched 3 minutes ago |
| ⚪ | clubs | the same, for clubs | src/crosswalk.py | 20 | — | rebuilt every run from the tables above |
| 🟢 | elo | team strength, which ranks the fixture term | clubelo.com | 3,576 | 17 Sep 06:07 | fetched 3 minutes ago |
| 🟢 | fixtures | who plays whom next, for the fixture term | analiticafantasy.com | 2,544 | 17 Sep 06:07 | fetched 3 minutes ago |
| 🟢 | lineups | probable XI percentages, both sources | analiticafantasy.com, futbolfantasy.com ×40 | 151,941 | 17 Sep 06:07 | fetched 3 minutes ago |
| 🟢 | market | price, value, position, fitness — every player in the game | futbolfantasy.com | 152,966 | 17 Sep 06:07 | fetched 3 minutes ago |
| 🟢 | matches | fixtures, kickoffs, results | futbolfantasy.com | 76,000 | 17 Sep 06:07 | fetched 3 minutes ago |
...
| 🟢 | starters | confirmed elevens, which is what P(start) is graded on | futbolfantasy.com | 185,534 | 17 Sep 06:07 | fetched 3 minutes ago |
...
| Predicted, total | 211 pts |
| Actual, total | 281 pts |
| **Mean absolute error (per match played)** | **3.3 pts** |
| Pairs predating the fixture term | 7 of 59 |
...
_26 of 59 intervals overpredicted, 33 underpredicted (mean signed error -1.2 pts) — the "Biggest miss" table below is the tail, not the whole picture._

_vs. a trivial guess (everyone scores the sample's own mean, 4.8 pts/match, no player identity at all): ours 3.29 MAE, that guess 3.34 MAE — does not clearly beat it yet (90% CI on the gap: -0.84 to +0.85 pts, straddles zero)._
...
| analitica | 2948 | 81% | 20% | 0.592 |
| futbolfantasy ←read | 8588 | 34% | 11% | 0.215 |
| our forecast | 362 | 60% | 18% | 0.379 |
| analitica — named, no number | 448 | — | 13% | — |
...
| within 10 points of 50%, on appearances | 1776 |
