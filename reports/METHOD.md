# Liga Five Guys — how the numbers are made — 2026-09-25 21:21 CEST
...
|---|---|---|---|--:|---|---|
| 🟢 | api_activity | every transfer, which is what the ledger replays — one row per deal, so the newest is the last deal and not the last sweep | LaLiga Fantasy API | 249 | 24 Sep 22:35 CEST | fetched 21 minutes ago |
| 🟢 | api_leagues | your cash and the league's id | LaLiga Fantasy API | 250 | 25 Sep 21:00 CEST | fetched 21 minutes ago |
| 🟢 | api_lineup | the eleven you have actually fielded, and the formation the app says you are playing | LaLiga Fantasy API | 2,497 | 25 Sep 21:00 CEST | fetched 21 minutes ago |
| 🟢 | api_market | what is on offer, and the bids on it | LaLiga Fantasy API | 7,887 | 25 Sep 21:00 CEST | fetched 21 minutes ago |
...
| 🟢 | api_standings | the league table — position, points, squad value, and your balance | LaLiga Fantasy API | 1,250 | 25 Sep 21:00 CEST | fetched 21 minutes ago |
| 🟢 | api_stats | what the app scored each player, broken into what he did — one row per player per week per stat, a correction being a later row rather than an overwrite | LaLiga Fantasy API | 15,709 | 24 Sep 22:35 CEST | fetched 21 minutes ago |
| 🟢 | api_teams | all five squads | LaLiga Fantasy API | 18,159 | 25 Sep 21:00 CEST | fetched 21 minutes ago |
| ⚪ | clubs | the same, for clubs | src/crosswalk.py | 20 | — | rebuilt every run from the tables above |
| 🟢 | elo | team strength, which ranks the fixture term | clubelo.com | 4,602 | 25 Sep 21:00 CEST | fetched 11 hours ago |
| 🟢 | fixtures | who plays whom next, for the fixture term | analiticafantasy.com | 3,103 | 25 Sep 21:00 CEST | fetched 11 hours ago |
| 🟢 | lineups | probable XI percentages, both sources | analiticafantasy.com, futbolfantasy.com ×40 | 25,580 | 25 Sep 21:00 CEST | fetched 21 minutes ago |
| 🟢 | market | price, value, position, fitness — every player in the game | futbolfantasy.com | 29,628 | 25 Sep 21:00 CEST | fetched 21 minutes ago |
| 🟢 | matches | fixtures, kickoffs, results | futbolfantasy.com | 96,520 | 25 Sep 21:00 CEST | fetched 11 hours ago |
...
| 🟢 | points | realised points per jornada, the actuals in every table below | futbolfantasy.com | 2,206 | 21 Sep 07:44 CEST | fetched 21 minutes ago |
...
_vs. a trivial guess (everyone scores the sample's own mean, 4.4 pts/match, no player identity at all): ours 2.96 MAE, that guess 3.04 MAE — does not clearly beat it yet (90% CI on the gap: -0.39 to +0.22 pts, straddles zero)._
...
|---|--:|--:|--:|--:|
| harder | 177 | 2.5 | 4.1 | -1.6 |
| neutral | 77 | 2.6 | 4.1 | -1.5 |
| easier | 175 | 3.3 | 5.0 | -1.7 |
...
**Fit from real data this run: 0.21** (h1 var 0.495, h3 var 0.579 (rate_rel-normalised, n=55/34) -> drift_frac 0.21).

### Rate uncertainty floor

**Fit from real data this run: 0.55** (Var(z)=1.86 at the shipped floor 0.55 -> best-fit 0.55 (n=288 real graded pairs, cv=0.991)).
