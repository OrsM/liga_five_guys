# Liga Five Guys — how the numbers are made — 2026-09-18 06:53 UTC
...
|---|---|---|---|--:|---|---|
| 🟢 | api_activity | every transfer, which is what the ledger replays — one row per deal, so the newest is the last deal and not the last sweep | LaLiga Fantasy API | 216 | 18 Sep 06:51 | fetched 3 minutes ago |
| 🟢 | api_leagues | your cash and the league's id | LaLiga Fantasy API | 205 | 18 Sep 06:51 | fetched 3 minutes ago |
| 🟢 | api_lineup | the eleven you have actually fielded, and the formation the app says you are playing | LaLiga Fantasy API | 2,002 | 18 Sep 06:51 | fetched 3 minutes ago |
| 🟢 | api_market | what is on offer, and the bids on it | LaLiga Fantasy API | 6,328 | 18 Sep 06:51 | fetched 3 minutes ago |
| 🟢 | api_players | names for players nobody owns any more — one row per player, first sighting kept | LaLiga Fantasy API | 135 | 17 Sep 20:40 | fetched 10 hours ago |
| 🟢 | api_standings | the league table — position, points, squad value, and your balance | LaLiga Fantasy API | 1,025 | 18 Sep 06:51 | fetched 3 minutes ago |
| 🟢 | api_stats | what the app scored each player, broken into what he did — one row per player per week per stat, a correction being a later row rather than an overwrite | LaLiga Fantasy API | 12,391 | 18 Sep 06:51 | fetched 3 minutes ago |
| 🟢 | api_teams | all five squads | LaLiga Fantasy API | 14,698 | 18 Sep 06:51 | fetched 3 minutes ago |
| ⚪ | clubs | the same, for clubs | src/crosswalk.py | 20 | — | rebuilt every run from the tables above |
| 🟢 | elo | team strength, which ranks the fixture term | clubelo.com | 3,728 | 18 Sep 06:51 | fetched 3 minutes ago |
| 🟢 | fixtures | who plays whom next, for the fixture term | analiticafantasy.com | 2,624 | 18 Sep 06:51 | fetched 3 minutes ago |
| 🟢 | lineups | probable XI percentages, both sources | analiticafantasy.com, futbolfantasy.com ×40 | 157,156 | 18 Sep 06:51 | fetched 3 minutes ago |
| 🟢 | market | price, value, position, fitness — every player in the game | futbolfantasy.com | 158,246 | 18 Sep 06:51 | fetched 3 minutes ago |
| 🟢 | matches | fixtures, kickoffs, results | futbolfantasy.com | 79,040 | 18 Sep 06:51 | fetched 3 minutes ago |
...
| 🟢 | points | realised points per jornada, the actuals in every table below | futbolfantasy.com | 1,795 | 17 Sep 06:07 | fetched 3 minutes ago |
| 🟢 | starters | confirmed elevens, which is what P(start) is graded on | futbolfantasy.com | 206,825 | 18 Sep 06:51 | fetched 3 minutes ago |
...
| Season spread, match to match | each round resamples a real per-match score, rescaled to the player's rate | from 1744 observed matches |
...
_22 of 54 intervals overpredicted, 32 underpredicted (mean signed error -1.5 pts) — the "Biggest miss" table below is the tail, not the whole picture._

_vs. a trivial guess (everyone scores the sample's own mean, 5.0 pts/match, no player identity at all): ours 3.30 MAE, that guess 3.42 MAE — does not clearly beat it yet (90% CI on the gap: -0.95 to +0.75 pts, straddles zero)._
...
| analitica | 2853 | 81% | 19% | 0.594 |
| futbolfantasy ←read | 8089 | 34% | 11% | 0.214 |
| our forecast | 343 | 60% | 18% | 0.380 |
| analitica — named, no number | 359 | — | 15% | — |
...
| within 10 points of 50%, on appearances | 1655 |
