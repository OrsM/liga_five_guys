# Liga Five Guys — how the numbers are made — 2026-09-12 06:57 UTC
...
|---|---|---|---|--:|---|---|
| 🟢 | api_activity | every transfer, which is what the ledger replays — one row per deal, so the newest is the last deal and not the last sweep | LaLiga Fantasy API | 184 | 11 Sep 20:25 | fetched 40 minutes ago |
| 🟢 | api_leagues | your cash and the league's id | LaLiga Fantasy API | 174 | 12 Sep 06:17 | fetched 40 minutes ago |
| 🟢 | api_lineup | the eleven you have actually fielded, and the formation the app says you are playing | LaLiga Fantasy API | 1,661 | 12 Sep 06:17 | fetched 40 minutes ago |
| 🟢 | api_market | what is on offer, and the bids on it | LaLiga Fantasy API | 5,217 | 12 Sep 06:17 | fetched 40 minutes ago |
| 🟢 | api_players | names for players nobody owns any more — one row per player, first sighting kept | LaLiga Fantasy API | 122 | 11 Sep 20:25 | fetched 11 hours ago |
| 🟢 | api_standings | the league table — position, points, squad value, and your balance | LaLiga Fantasy API | 870 | 12 Sep 06:17 | fetched 40 minutes ago |
| 🟢 | api_stats | what the app scored each player, broken into what he did — one row per player per week per stat, a correction being a later row rather than an overwrite | LaLiga Fantasy API | 8,559 | 12 Sep 06:17 | fetched 40 minutes ago |
| 🟢 | api_teams | all five squads | LaLiga Fantasy API | 12,310 | 12 Sep 06:17 | fetched 40 minutes ago |
| ⚪ | clubs | the same, for clubs | src/crosswalk.py | 20 | — | rebuilt every run from the tables above |
| 🟢 | elo | team strength, which ranks the fixture term | clubelo.com | 3,120 | 12 Sep 06:17 | fetched 40 minutes ago |
| 🟢 | fixtures | who plays whom next, for the fixture term | analiticafantasy.com | 2,337 | 12 Sep 06:17 | fetched 40 minutes ago |
| 🟢 | lineups | probable XI percentages, both sources | analiticafantasy.com, futbolfantasy.com ×40 | 137,664 | 12 Sep 06:17 | fetched 40 minutes ago |
| 🟢 | market | price, value, position, fitness — every player in the game | futbolfantasy.com | 137,791 | 12 Sep 06:17 | fetched 40 minutes ago |
| 🟢 | matches | fixtures, kickoffs, results | futbolfantasy.com | 67,260 | 12 Sep 06:17 | fetched 40 minutes ago |
...
| 🟢 | points | realised points per jornada, the actuals in every table below | futbolfantasy.com | 1,267 | 11 Sep 20:25 | fetched 40 minutes ago |
| 🟢 | starters | confirmed elevens, which is what P(start) is graded on | futbolfantasy.com | 134,497 | 12 Sep 06:17 | fetched 40 minutes ago |
...
| Predicted, total | 209 pts |
| Actual, total | 240 pts |
| **Mean absolute error (per match played)** | **3.0 pts** |
| Pairs predating the fixture term | 8 of 60 |
...
_28 of 60 intervals overpredicted, 32 underpredicted (mean signed error -0.5 pts) — the "Biggest miss" table below is the tail, not the whole picture._

_vs. a trivial guess (everyone scores the sample's own mean, 4.0 pts/match, no player identity at all): ours 2.98 MAE, that guess 3.17 MAE — does not clearly beat it yet (90% CI on the gap: -0.84 to +0.50 pts, straddles zero)._
...
| analitica | 2428 | 79% | 20% | 0.571 |
| futbolfantasy ←read | 8250 | 36% | 10% | 0.238 |
| our forecast | 322 | 64% | 19% | 0.412 |
| analitica — named, no number | 724 | — | 8% | — |
| futbolfantasy — named, no number | 2 | — | 0% | — |

| Not graded | Calls |
|---|--:|
| within 10 points of 50%, on starts | 421 |
| within 10 points of 50%, on appearances | 1632 |
