# Liga Five Guys — how the numbers are made — 2026-08-25 15:16 UTC
...
|---|---|--:|--:|
| **Act today** | 52 players you can buy now | +99 | — |
...
| Tenth percentile of a week's waiting | +1.36 |
| Market model | the market is modelled from 183 offers over 11 cycles, weighted by value^0.15, and only just — value^0.30 fits within 16.5% of it, so read the exponent as roughly this, not exactly this |
...
| 🟢 | api_leagues | your cash and the league's id | LaLiga Fantasy API | 98 | 25 Aug 15:16 | fetched 1 minute ago |
| 🟢 | api_lineup | the eleven you have actually fielded, and the formation the app says you are playing | LaLiga Fantasy API | 825 | 25 Aug 15:16 | fetched 1 minute ago |
| 🟢 | api_market | what is on offer, and the bids on it | LaLiga Fantasy API | 3,006 | 25 Aug 15:16 | fetched 1 minute ago |
| 🟢 | api_players | names for players nobody owns any more — one row per player, first sighting kept | LaLiga Fantasy API | 79 | 24 Aug 22:02 | fetched 17 hours ago |
| 🟢 | api_standings | the league table — position, points, squad value, and your balance | LaLiga Fantasy API | 490 | 25 Aug 15:16 | fetched 1 minute ago |
...
| 🟢 | api_teams | all five squads | LaLiga Fantasy API | 7,001 | 25 Aug 15:16 | fetched 1 minute ago |
| ⚪ | clubs | the same, for clubs | src/crosswalk.py | 20 | — | rebuilt every run from the tables above |
| 🟢 | elo | team strength, which ranks the fixture term | clubelo.com | 1,600 | 25 Aug 15:16 | fetched 14 hours ago |
| 🟢 | fixtures | who plays whom next, for the fixture term | analiticafantasy.com | 1,501 | 25 Aug 15:16 | fetched 14 hours ago |
| 🟢 | lineups | probable XI percentages, both sources | analiticafantasy.com, futbolfantasy.com ×40 | 91,026 | 25 Aug 15:16 | fetched 1 hour ago |
| 🟢 | market | price, value, position, fitness — every player in the game | futbolfantasy.com | 86,990 | 25 Aug 15:16 | fetched 1 minute ago |
| 🟢 | matches | fixtures, kickoffs, results | futbolfantasy.com | 38,380 | 25 Aug 15:16 | fetched 14 hours ago |
...
| 🟢 | starters | confirmed elevens, which is what P(start) is graded on | futbolfantasy.com | 30,982 | 25 Aug 15:16 | fetched 14 hours ago |
