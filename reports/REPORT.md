# Liga Five Guys — one report — 2026-08-13 15:35 UTC
...
**21 of these are on offer right now** (from the slate you pasted in) — they sort to the top of each position and carry a ✅.
...
| Player | Team | Pos | Value | 24h | Start% | On offer |
|---|---|--:|--:|--:|--:|---|
| oihan sancet | Athletic | med | 49.41M | -1.05M | 70% | ✅ |
| arda guler | Real Madrid | med | 50.84M | 195K | 60% | ✅ |
...
| Player | Team | Pos | Value | 24h | Start% | On offer |
|---|---|--:|--:|--:|--:|---|
| asier villalibre | Racing | del | 6.95M | -76K | 70% | ✅ |
| giuliano simeone | Atlético | del | 44.74M | -566K | 70% | ✅ |
...
- **Gerard** — could be gerard martin, gerard moreno
- **Joaquín** — could be joaquin oso, joaquin muñoz
