# Liga Five Guys — one report — 2026-08-13 14:58 UTC
...
**No longer on offer** — owned per the ledger, so they are not rankable. Delete them from `inputs/offers.txt`.

- abde ezzalzouli — Albert Laporta
- ayoze perez — Albert Laporta
- ferran jutgla — Albert Laporta
- jon karrikaburu — Magic Mike 333
- juan foyth — Albert Laporta
- marko dmitrovic — BurtonGM89
- pedro diaz — Magic Mike 333
- raphinha — Magic Mike 333
...
_Generated 2026-08-13 14:58 UTC._
