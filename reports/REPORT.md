# Liga Five Guys — one report — 2026-08-14 21:57 UTC
...
**Squad 171.04M** · cash 62.89M · total 233.93M — balance last checked 2026-08-12, but the ledger moved on 2026-08-14. Re-check it.
...
| Player | Pos | Value | Start% | Score | XI gain | Bid | Competition | Verdict |
|---|---|--:|--:|--:|--:|--:|---|---|
| Pablo Fornals | med | 58.30M | 80% | 5.4 | +2.7 | 59.84M–62.89M | nobody short | **Bid** — XI +2.7 |
| Santiago Mouriño | def | 40.60M | 70% | 3.1 | +0.7 | 41.67M–49.37M | nobody short | **Bid** — XI +0.7 |
| Mario Martin | med | 3.74M | 80% | 2.3 | -0.4 | 3.84M–4.55M | nobody short | pass — XI -0.4 |
| Pelayo Fernandez | def | 1.72M | 50% | 1.9 | -0.5 | 1.77M–2.09M | nobody short | pass — XI -0.5 |
| Clemens Riedel | def | 4.66M | 50% | 1.9 | -0.5 | 4.78M–5.66M | nobody short | pass — XI -0.5 |
| Oriol Rey | med | 742K | 50% | 1.7 | -1.0 | 762K–902K | nobody short | pass — XI -1.0 |
| Dani Vivian | def | 11.14M | 30% | 1.2 | -1.2 | 11.43M–13.54M | nobody short | pass — XI -1.2 |
| Alex Freeman | def | 2.48M | 30% | 1.0 | -1.4 | 2.54M–3.01M | nobody short | pass — XI -1.4 |
| Zakaria Eddahchouri | del | 1.91M | 30% | 0.9 | -1.5 | 1.96M–2.32M | BurtonGM89 | pass — XI -1.5 |
...
|---|---|--:|--:|--:|--:|---|
| POR | Ionut Radu | 90% | 39.71M | -350K | 5.9 | 254p/38j |
...
| MED | Lucien Agoume | 80% | 5.79M | 21K | 3.2 | 133p/34j |
...
|---|---|--:|--:|--:|--:|---|
| Alvaro Fernandez | por | 4.80M | 0.9 | -5.1 | 5.50M | 3rd POR — only 1 can ever play |
| Dani Lorenzo | med | 9.66M | 2.6 | -0.1 | 3.78M | 6th MED — only 5 can ever play |
| Beñat Turrientes | med | 6.99M | 2.5 | -0.2 | 2.78M | 7th MED — only 5 can ever play |
| Simon Eriksson | por | 2.93M | 2.2 | -3.8 | 1.35M | 2nd POR — only 1 can ever play |
...
_Generated 2026-08-14 21:57 UTC._
...
|---|---|--:|--:|--:|--:|
| santiago mouriño | Villarreal | def | 40.60M | 200K | 70% |
| pelayo fernandez | Rayo | def | 1.72M | 0K | 50% |
| clemens riedel | Espanyol | def | 4.66M | -76K | 50% |
| alex freeman | Villarreal | def | 2.48M | -42K | 30% |
| dani vivian | Athletic | def | 11.14M | -346K | 30% |

### mediocampista

| Player | Team | Pos | Value | 24h | Start% |
|---|---|--:|--:|--:|--:|
| mario martin | Getafe | med | 3.74M | -131K | 80% |
| pablo fornals | Betis | med | 58.30M | -466K | 80% |
| oriol rey | Levante | med | 742K | -11K | 50% |

### delantero

| Player | Team | Pos | Value | 24h | Start% |
|---|---|--:|--:|--:|--:|
| zakaria eddahchouri | Deportivo | del | 1.91M | -27K | 30% |
