...
**Locks in 26h** (next kickoff) · squad 229.94M · cash 63.29M · total 293.24M · λ 0.10 pts/M · buy over 0.13
...
|---|---|--:|--:|--:|--:|--:|---|---|
| Alvaro Fernandez | por | 4.19M–5.33M | any | 0.0 | 0.00 | 0.00× | **Sell** | 3rd POR — only 1 can ever play |
| Beñat Turrientes | med | 6.43M–8.18M | any | 0.0 | 0.00 | 0.00× | **Sell** | 8th MED — only 5 can ever play |
| Simon Eriksson | por | 2.62M–3.34M | any | 0.0 | 0.00 | 0.00× | **Sell** | 2nd POR — only 1 can ever play |
| Ruben Garcia | med | 12.49M–15.89M | 1.50M | 0.2 | 0.01 | 0.11× | **Sell** | outscored |
| Pablo Fornals | med | 51.92M–66.09M | 21.68M | 2.7 | 0.05 | 0.37× | **Sell** | outscored |
...
_Generated 2026-08-16 17:26 UTC._
