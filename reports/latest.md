...
| +DEL | _Pierre-Emerick Aubameyang_ | Malaga A ★ | ~3.0 | +6% | 90% | — | **+0.2** |
...
- Balance last checked 2026-08-19, but the ledger moved on 2026-08-20. Re-check it.
...
| Player | Value | 24h | % |
|---|--:|--:|--:|
| Omar El Hilali | 10.10M | 355K | +3.65% |
