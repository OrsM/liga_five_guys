# Liga Five Guys — how the numbers are made — 2026-09-16 14:00 CEST
...
|---|---|---|---|--:|---|---|
| 🟢 | api_activity | every transfer, which is what the ledger replays — one row per deal, so the newest is the last deal and not the last sweep | LaLiga Fantasy API | 216 | 18 Sep 08:51 CEST | fetched 1 minute ago |
| 🟢 | api_leagues | your cash and the league's id | LaLiga Fantasy API | 213 | 18 Sep 21:29 CEST | fetched 1 minute ago |
| 🟢 | api_lineup | the eleven you have actually fielded, and the formation the app says you are playing | LaLiga Fantasy API | 2,090 | 18 Sep 21:29 CEST | fetched 1 minute ago |
| 🟢 | api_market | what is on offer, and the bids on it | LaLiga Fantasy API | 6,560 | 18 Sep 21:29 CEST | fetched 1 minute ago |
| 🟢 | api_players | names for players nobody owns any more — one row per player, first sighting kept | LaLiga Fantasy API | 135 | 17 Sep 22:40 CEST | fetched 1 minute ago |
| 🟢 | api_standings | the league table — position, points, squad value, and your balance | LaLiga Fantasy API | 1,065 | 18 Sep 21:29 CEST | fetched 1 minute ago |
| 🟢 | api_stats | what the app scored each player, broken into what he did — one row per player per week per stat, a correction being a later row rather than an overwrite | LaLiga Fantasy API | 12,580 | 18 Sep 21:18 CEST | fetched 1 minute ago |
| 🟢 | api_teams | all five squads | LaLiga Fantasy API | 15,306 | 18 Sep 21:29 CEST | fetched 1 minute ago |
| ⚪ | clubs | the same, for clubs | src/crosswalk.py | 20 | — | rebuilt every run from the tables above |
| 🟢 | elo | team strength, which ranks the fixture term | clubelo.com | 3,880 | 18 Sep 21:29 CEST | fetched 1 minute ago |
| 🟢 | fixtures | who plays whom next, for the fixture term | analiticafantasy.com | 2,704 | 18 Sep 21:29 CEST | fetched 1 minute ago |
| 🟢 | lineups | probable XI percentages, both sources | analiticafantasy.com, futbolfantasy.com ×40 | 162,832 | 18 Sep 21:29 CEST | fetched 1 minute ago |
| 🟢 | market | price, value, position, fitness — every player in the game | futbolfantasy.com | 163,526 | 18 Sep 21:29 CEST | fetched 1 minute ago |
| 🟢 | matches | fixtures, kickoffs, results | futbolfantasy.com | 82,080 | 18 Sep 21:29 CEST | fetched 1 minute ago |
...
| 🟢 | starters | confirmed elevens, which is what P(start) is graded on | futbolfantasy.com | 228,753 | 18 Sep 21:29 CEST | fetched 1 minute ago |
...
| Predicted, total | 218 pts |
| Actual, total | 285 pts |
| **Mean absolute error (per match played)** | **3.2 pts** |
| Pairs predating the fixture term | 8 of 63 |
...
_28 of 63 intervals overpredicted, 35 underpredicted (mean signed error -1.1 pts) — the "Biggest miss" table below is the tail, not the whole picture._

_vs. a trivial guess (everyone scores the sample's own mean, 4.5 pts/match, no player identity at all): ours 3.18 MAE, that guess 3.30 MAE — does not clearly beat it yet (90% CI on the gap: -0.92 to +0.70 pts, straddles zero)._
...
|---|--:|--:|--:|--:|
| harder | 31 | 3.5 | 5.5 | -1.9 |
| neutral | 11 | 4.0 | 4.7 | -0.7 |
| easier | 13 | 3.9 | 3.2 | +0.7 |
...
| analitica | 3235 | 81% | 19% | 0.597 |
| futbolfantasy ←read | 9649 | 34% | 11% | 0.220 |
| our forecast | 854 | 50% | 13% | 0.346 |
| analitica — named, no number | 555 | — | 11% | — |
...
| within 10 points of 50%, on appearances | 2067 |
