...
| 🟢 | api_leagues | your cash and the league's id | LaLiga Fantasy API | 212 | 18 Sep 21:18 CEST | fetched 1 minute ago |
| 🟢 | api_lineup | the eleven you have actually fielded, and the formation the app says you are playing | LaLiga Fantasy API | 2,079 | 18 Sep 21:18 CEST | fetched 1 minute ago |
| 🟢 | api_market | what is on offer, and the bids on it | LaLiga Fantasy API | 6,536 | 18 Sep 21:18 CEST | fetched 1 minute ago |
...
| 🟢 | api_standings | the league table — position, points, squad value, and your balance | LaLiga Fantasy API | 1,060 | 18 Sep 21:18 CEST | fetched 1 minute ago |
...
| 🟢 | api_teams | all five squads | LaLiga Fantasy API | 15,230 | 18 Sep 21:18 CEST | fetched 1 minute ago |
| ⚪ | clubs | the same, for clubs | src/crosswalk.py | 20 | — | rebuilt every run from the tables above |
| 🟢 | elo | team strength, which ranks the fixture term | clubelo.com | 3,861 | 18 Sep 21:18 CEST | fetched 1 minute ago |
| 🟢 | fixtures | who plays whom next, for the fixture term | analiticafantasy.com | 2,694 | 18 Sep 21:18 CEST | fetched 1 minute ago |
| 🟢 | lineups | probable XI percentages, both sources | analiticafantasy.com, futbolfantasy.com ×40 | 162,121 | 18 Sep 21:18 CEST | fetched 1 minute ago |
| 🟢 | market | price, value, position, fitness — every player in the game | futbolfantasy.com | 162,866 | 18 Sep 21:18 CEST | fetched 1 minute ago |
| 🟢 | matches | fixtures, kickoffs, results | futbolfantasy.com | 81,700 | 18 Sep 21:18 CEST | fetched 1 minute ago |
...
| 🟢 | starters | confirmed elevens, which is what P(start) is graded on | futbolfantasy.com | 226,012 | 18 Sep 21:18 CEST | fetched 1 minute ago |
